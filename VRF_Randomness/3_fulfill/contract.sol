...
contract RandomNumberConsumer is VRFConsumerBase {
    ...
    // <Ethereum Mainnet VRF Coordinator Address>, <LINK Token Address>
    ...
    function getRandomNumber() public returns (bytes32) {
        require(LINK.balanceOf(address(this)) >= fee, "Not enough LINK in account");
        bytes32 requestId = requestRandomness(keyHash, fee); 
        return requestId;
    }
    
    function fulfillRandomness(bytes32, uint256 random) internal override {
        randomResult = random;
    }
}